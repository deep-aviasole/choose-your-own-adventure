...
function StoryGame({ story, onNewStory }) {
    const [currenNodeId, setCurrentNodeId] = useState(null);
    const [currenNode, setCurrentNode] = useState(null);
    ...
    useEffect(() => {
        if (currenNodeId && story && story.all_nodes) {
            const node = story.all_nodes[currenNodeId]
    ...
    return <div className="story-game">
        ...
        <div className="story-content">
            {currenNode && <div className="story-node">
                <p>{currenNode.content}</p>
